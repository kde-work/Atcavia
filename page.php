        ...
        <div class="layout__box">
            <div class="sub-content">
                ...
                <div class="sub-content__sidebar sidebar scroll-content">
                    <div class="sub-content__btn btn btn--big-alpha btn-target btn--shadow btn-target--1 btn--scroll-btn-on-page"><?php echo nbsp( __t( 'Связаться с нами', 'Connect with Us' )); ?></div>
                    <?php
